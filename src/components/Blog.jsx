...
export default function Blog({ limit }) {
  ...
  return (
    <section id="blog" className="relative py-8 overflow-hidden bg-[#E2D5F3] text-gray-900 z-10">
      ...
      <div className="absolute top-0 left-0 w-2.5 h-2.5 bg-gradient-to-r from-[#6B1736] to-transparent rounded-full animate-shooting-1 pointer-events-none shadow-[0_0_10px_2px_rgba(107,23,54,0.2)]" style={{ transform: 'rotate(45deg)' }} />
      <div className="absolute top-0 left-0 w-2.5 h-2.5 bg-gradient-to-r from-[#3E0844] to-transparent rounded-full animate-shooting-2 pointer-events-none shadow-[0_0_10px_2px_rgba(62,8,68,0.2)]" style={{ transform: 'rotate(45deg)' }} />

      {/* 🌌 High-density Starfield (Twinkling Soft Stars) */}
      {[...Array(45)].map((_, i) => (
        <div
          key={`star-${i}`}
          className="absolute rounded-full bg-[#6B1736]/15 animate-twinkle pointer-events-none"
          style={{
      ...
      {[...Array(8)].map((_, i) => (
        <svg
          key={`sparkle-${i}`}
          className="absolute text-[#6B1736]/25 animate-sparkle pointer-events-none drop-shadow-[0_0_6px_rgba(107,23,54,0.15)]"
          style={{
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[750px] pointer-events-none z-0 hidden md:block" style={{ perspective: '1000px' }}>
        <div className="relative w-full h-full transform-gpu" style={{ transform: 'rotateX(72deg) rotateY(6deg)' }}>
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-36 h-36 rounded-full bg-gradient-to-br from-[#6B1736]/15 via-[#3E0844]/15 to-[#E2D5F3] opacity-35 blur-[50px] animate-pulse" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 rounded-full bg-[#6B1736]/10 border border-[#6B1736]/25 shadow-[0_0_20px_rgba(107,23,54,0.1)]" />
          
          {/* Orbit 1 */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[240px] h-[240px] rounded-full border border-dashed border-[#6B1736]/20 animate-solar-cw">
            {/* Orbiting Planet Node */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3.5 h-3.5 rounded-full bg-[#6B1736]/60 shadow-[0_0_8px_rgba(107,23,54,0.3)]" />
          </div>

          {/* Orbit 2 */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[420px] h-[420px] rounded-full border border-dotted border-purple-400/25 animate-solar-ccw">
            {/* Orbiting Planet Node */}
            <div className="absolute bottom-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 rounded-full bg-[#A047B8]/70 shadow-[0_0_8px_rgba(160,71,184,0.3)]" />
          </div>

          {/* Orbit 3 */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-dashed border-[#3E0844]/10 animate-solar-cw">
            {/* Orbiting Planet Node */}
            <div className="absolute right-0 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full bg-indigo-500/60 shadow-[0_0_8px_rgba(99,102,241,0.3)]" />
          </div>
        </div>
      </div>

      {/* 🕸️ Cosmic Solar Grid / Constellation Mesh Network ("Solar Panel" grid lines) */}
      <svg className="absolute inset-0 w-full h-full text-[#3E0844]/5 opacity-40 pointer-events-none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="solarGridLight" width="120" height="120" patternUnits="userSpaceOnUse">
            <circle cx="60" cy="60" r="1.5" fill="#6B1736" opacity="0.2" />
            <path d="M 120 0 L 0 120 M 0 0 L 120 120" fill="none" stroke="currentColor" strokeWidth="0.3" opacity="0.1" />
            <circle cx="0" cy="0" r="1" fill="#6B1736" opacity="0.15" />
            <circle cx="120" cy="0" r="1" fill="#6B1736" opacity="0.15" />
            <circle cx="0" cy="120" r="1" fill="#6B1736" opacity="0.15" />
            <circle cx="120" cy="120" r="1" fill="#6B1736" opacity="0.15" />
      ...
      <div className="absolute top-[15%] left-[-5%] w-[45vw] h-[45vw] rounded-full bg-gradient-to-br from-purple-200/30 to-transparent blur-[120px] pointer-events-none animate-drift" />
      ...
      <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {limit && (
          <div className="text-center max-w-3xl mx-auto mb-8">
            <span className="inline-flex items-center gap-1.5 text-xs font-bold tracking-widest text-[#6B1736] uppercase mb-3 animate-tagline-blink">
              <BookOpen className="w-3.5 h-3.5 animate-pulse text-[#6B1736]" />
              Spiritual Wisdom &amp; Course Insights
            </span>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1C0320] mb-4">
              Our Blogs
            </h2>
            <div className="w-20 h-1 bg-gradient-to-r from-[#3E0844] to-[#6B1736] mx-auto rounded-full mb-5" />
              ...
              >
                ...
                >
                  <div className="relative group w-full max-w-md">
                    ...
                    <div className="absolute inset-0 bg-[#6B1736]/5 rounded-[2.5rem] transform rotate-2 scale-[1.02] opacity-0 group-hover:opacity-100 transition-all duration-700" />
                    ...
                    <div className="relative z-10 rounded-[2.5rem] overflow-hidden shadow-xl border border-purple-100/50 aspect-square bg-purple-50 w-full">
                      ...
                      {/* Topic Icon Badge */}
                      <div className="absolute top-4 left-4 w-11 h-11 rounded-2xl bg-white/90 backdrop-blur-md border border-purple-100 flex items-center justify-center text-[#6B1736] shadow-lg group-hover:scale-110 transition-transform duration-300">
                ...
                >
                  <div className="space-y-3">
                    ...
                    <span className="inline-flex items-center gap-1.5 text-[10px] font-black uppercase tracking-widest text-[#6B1736] bg-[#6B1736]/10 border border-[#6B1736]/25 px-4 py-2 rounded-full">
                      <Award className="w-3 h-3 text-[#6B1736]" /> {post.course}
                    </span>
                  ...
                  <div className="space-y-4">
                    <p className="text-[#6B1736] text-xs sm:text-sm font-bold tracking-wide italic max-w-xl mx-auto lg:mx-0">
                      "{post.tagline}"
                    </p>
        ...
        {!limit && (
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-between gap-4 border-t border-purple-200/60 pt-6">
            {/* Status Info */}
            ...
            {totalPages > 1 ? (
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={`inline-flex items-center justify-center p-2.5 rounded-xl border transition-all duration-300 ${currentPage === 1
                      ? 'border-purple-200/40 text-purple-200 cursor-not-allowed'
                      : 'border-purple-200 text-[#3E0844] hover:bg-white hover:border-purple-300 active:scale-90 cursor-pointer shadow-sm hover:shadow'
                    }`}
                  ...
                  return (
                    <button
                      ...
                      className={`w-9 h-9 rounded-xl border text-xs font-black transition-all duration-300 ${currentPage === pageNum
                          ? 'bg-[#3E0844] border-[#3E0844] text-[#F5D28E] shadow-[0_0_12px_rgba(62,8,68,0.15)]'
                          : 'bg-transparent border-purple-200 text-gray-700 hover:bg-white hover:border-purple-300 hover:text-[#3E0844] cursor-pointer'
                        }`}
                    >
                      {pageNum}
                    </button>
              ...
              <span className="text-[10px] font-black uppercase text-[#6B1736] bg-[#6B1736]/10 border border-[#6B1736]/20 px-4 py-1.5 rounded-full tracking-widest leading-none">
                All articles loaded
              </span>
            )}
          </div>
