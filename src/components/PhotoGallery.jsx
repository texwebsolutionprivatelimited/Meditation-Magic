...
import gallery1 from '../assets/neelam_gallery_1.jpg';
import gallery2 from '../assets/neelam_gallery_2.jpg';
import gallery3 from '../assets/neelam_gallery_3.jpg';
import gallery4 from '../assets/neelam_gallery_4.jpg';
import gallery5 from '../assets/neelam_gallery_5.jpg';
...
export default function PhotoGallery() {
  ...
  const images = [
    {
      ...
      alt: "Neelam Arora podcasting with microphone in armchair",
    ...
    },
    {
      src: gallery1,
      tag: "Guest Session",
      alt: "Neelam Arora with guests in professional podcast studio",
    ...
    },
    {
      ...
      alt: "Neelam Arora, Co-Facilitator Bhavya Chudasama, and a guest celebrating spiritual alignment",
      title: "Celebrating Alignment & Success",
      desc: "Bhavya Chudasama co-guides this sacred platform with Neelam, bridging high-frequency healing with practical lifestyle transformation."
    },
    {
      src: gallery4,
      tag: "Book Presentation",
      alt: "Neelam Arora receiving 'Manifest anything in 100 days' book from a guest",
      title: "A Gift of Manifestation",
      desc: "Neelam Arora receiving the book 'Manifest anything in 100 days' as a presentation from a grateful guest seeker."
    },
    {
      src: gallery5,
      tag: "Divine Flow",
      alt: "Neelam Arora gesturing dynamically on podcast",
  ...
  return (
    <section id="gallery" className="relative pt-3 pb-4 sm:pt-8 sm:pb-10 lg:pt-10 lg:pb-14 bg-[#E2D5F3] overflow-hidden">
      ...
      <div className="absolute bottom-10 left-[-15%] w-80 h-80 rounded-full bg-purple-100/40 blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-[95%] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
          ...
          <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#1C0320] leading-tight">
            Photo Gallery
          </h2>
          <div className="w-20 h-1 bg-gradient-to-r from-[#3E0844] to-[#6B1736] mx-auto rounded-full mt-3 mb-4" />
          <p className="text-gray-700 text-xs sm:text-sm font-semibold max-w-2xl mx-auto leading-relaxed">
            Peek into Neelam Arora's high-energy studio recordings, podcast sessions, and spiritual workshops where seekers gather to raise their vibrations.
          </p>
        </div>
            ...
            {images.slice(1).map((img, idx) => {
              ...
              return (
                <div 
                  ...
                  className="relative rounded-[2rem] overflow-hidden border-2 border-[#3E0844]/40 hover:border-[#3E0844] shadow-md hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 cursor-pointer group h-72 sm:h-80"
                >
                  <img 
                    src={img.src} 
                    alt={img.alt} 
