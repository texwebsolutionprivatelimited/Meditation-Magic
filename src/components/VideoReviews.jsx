...
const videos = [
  {
    id: 'TRH08Ip3NtY',
    title: 'Live Testimonials of Dragon Therapy workshop level -1 by Participants',
    tag: 'Dragon Therapy Level-1',
    stars: 5,
  },
  {
    id: 'K3pBq2m8KGY',
    title: 'LIVE TESTIMONIALS OF PSYCHIC SURGERY THROUGH ARCHANGELS',
    tag: 'Psychic Surgery',
    stars: 5,
  },
  {
    id: '-PZksUvvDCo',
    title: 'Live Testimonials of Angel Therapy Workshop',
    tag: 'Angel Therapy',
    stars: 5,
  },
  {
    id: 't6EolfzFtpY',
    title: '🐉 Live Testimonials: Dragon Therapy Level-2 Workshop | Advanced Healing & Magic',
    tag: 'Dragon Therapy Level-2',
    stars: 5,
  },
];
      ...
      <div className="max-w-[95%] mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
          {videos.map((v) => (
            <div
              key={v.id}
              className="group bg-white rounded-2xl overflow-hidden border border-purple-200/80 shadow-md hover:shadow-lg transition-all duration-300 cursor-pointer flex flex-col justify-between"
            ...
            >
              ...
              <div>
                <div className="relative aspect-video overflow-hidden bg-black">
                  ...
                  {/* Tag */}
                  <span className="absolute top-2 left-2 text-[8px] font-bold bg-[#3E0844]/80 text-[#F5D28E] px-2.5 py-1 rounded-full backdrop-blur-sm border border-[#F5D28E]/10">
                    {v.tag}
                  </span>
                </div>
                ...
                <div className="p-3.5 sm:p-4">
                  ...
                  <h4 className="font-serif font-bold text-sm text-[#1C0320] leading-snug group-hover:text-[#3E0844] transition-colors mb-3">
                    {v.title}
                  </h4>
                </div>
              </div>
        ...
        <div className="text-center">
          <a
            ...
            className="inline-flex items-center gap-2 bg-red-600 hover:bg-red-700 text-white font-bold text-xs px-4 sm:px-8 py-3.5 rounded-xl transition-all duration-300 shadow-md hover:shadow-lg active:scale-95 uppercase tracking-wider whitespace-nowrap"
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            <span className="hidden sm:inline">Watch More Videos on YouTube</span>
            <span className="inline sm:hidden">Watch on YouTube</span>
          </a>
        </div>
