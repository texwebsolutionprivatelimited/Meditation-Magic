...
export default function Navbar({ onOpenModal, cart = [], onRemoveFromCart, onClearCart, onAddToCart }) {
  ...
  const courseDropdownItems = [
    ...
    { name: '1-to-1 Sessions', href: '/courses?type=1-to-1 Sessions', icon: <HeartHandshake className="w-5 h-5" /> },
  ];
  ...
  const isDropdownItemActive = (item) => {
    ...
    if (item.name === '1-to-1 Sessions') {
      return (location.search.includes('type=1-to-1 Sessions') || location.search.includes('type=1-to-1%20Sessions')) || (currentCourseType === '1-to-1 Session');
    }
    return false;
  };
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="md:hidden text-white/80 hover:text-[#F5D28E] p-2 rounded-lg hover:bg-white/10 transition-all duration-200"
          ...
          <div className="relative w-80 max-w-full bg-white shadow-2xl flex flex-col z-10 overflow-y-auto">
            ...
            {cart.length > 0 && (
              <div className="p-4 border-t border-purple-100 space-y-3">
                ...
                <button
                  onClick={onClearCart}
                  className="w-full border border-purple-200 text-[#3E0844]/70 font-bold py-2.5 rounded-xl text-xs uppercase tracking-wider transition-all hover:bg-purple-50"
                >
                  Clear Cart
                </button>
              </div>
