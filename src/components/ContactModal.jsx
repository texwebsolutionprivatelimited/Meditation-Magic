  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg glass-card rounded-3xl p-6 sm:p-8 overflow-hidden shadow-2xl border border-gold/20 animate-float-slow">
        ...
        <div className="absolute -bottom-24 -right-24 w-48 h-48 rounded-full bg-tealGlow/30 blur-3xl pointer-events-none"></div>
        ...
        {isSubmitted ? (
          <div className="text-center py-10 flex flex-col items-center justify-center animate-pulse-slow">
            ...
            <h3 className="font-serif text-2xl font-bold text-gold mb-2">Manifestation Received!</h3>
            <p className="text-cosmic-light text-sm max-w-sm">
              Thank you, <span className="text-gold font-semibold">{formData.name}</span>. Your intention has been aligned. Neelam Aurora's team will contact you shortly via email or phone to complete your registration.
            </p>
            <div className="mt-6 flex items-center gap-1 text-xs text-gold/60">
              <Sparkles className="w-3.5 h-3.5" />
              <span>Frequency Aligned to Abundance</span>
            </div>
          </div>
        ) : (
          <>
            ...
            <div className="flex items-center gap-3 mb-6 border-b border-gold/10 pb-4">
              ...
              <div>
                <h3 className="font-serif text-xl font-bold text-gold">Align Your Energy</h3>
                <p className="text-xs text-cosmic-light">Begin your transformation with Neelam Arora</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-gold/80 uppercase tracking-wider mb-1">Your Manifestation Goals / Query</label>
                <textarea 
                  rows="3"
