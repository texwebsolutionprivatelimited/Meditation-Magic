      ...
      <div className="max-w-[95%] mx-auto px-3 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="w-full bg-white/35 backdrop-blur-md rounded-[1.25rem] sm:rounded-[2.5rem] border border-[#3E0844]/10 sm:border-purple-300/50 shadow-xl overflow-hidden relative z-10">
          ...
          <div className="p-3 sm:p-12 pb-4 sm:pb-6 border-b border-purple-300/40 text-center sm:text-left">
            ...
            {/* Title */}
            <h1 className="font-serif text-xl sm:text-4xl lg:text-5xl font-black text-[#1C0320] leading-tight mb-4">
              {post.title}
            </h1>
            ...
            {/* Author */}
            <div className="flex items-center justify-center sm:justify-start gap-3 mt-5 sm:mt-6 pt-5 border-t border-purple-50/50">
              <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-full bg-gradient-to-tr from-[#3E0844] to-[#6B1736] text-white flex items-center justify-center font-black text-xs shadow-md">
                NA
              </div>
          ...
          <div className="p-3 sm:p-12 pt-5 sm:pt-10 space-y-5 sm:space-y-8 font-medium text-gray-700 text-xs sm:text-sm leading-relaxed text-left">
            ...
            <div className="my-5 sm:my-6 border-l-4 border-[#6B1736] bg-gradient-to-r from-[#3E0844]/5 to-transparent p-4 sm:p-5 pl-5 sm:pl-8 rounded-r-xl text-left relative overflow-hidden">
              <span className="absolute right-4 bottom-[-10px] text-6xl sm:text-7xl font-serif text-[#6B1736]/10 pointer-events-none select-none">”</span>
              <p className="font-serif text-xs sm:text-base font-black text-[#3E0844] relative z-10 leading-relaxed italic">
                "{post.quote}"
              </p>
            </div>
            ...
            {post.sections.map((sec, idx) => (
              <div key={idx} className="space-y-3 sm:space-y-4">
                <h3 className="font-serif text-base sm:text-xl font-black text-[#1C0320] flex items-center gap-1.5 sm:gap-2">
                  <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#6B1736]" /> {sec.heading}
                </h3>
            ...
            <div className="bg-[#3E0844]/5 border border-purple-100 rounded-[1.25rem] sm:rounded-[2.25rem] p-3.5 sm:p-8 space-y-4 my-6">
              <div className="flex items-center gap-3 border-b border-purple-100 pb-3.5">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-gradient-to-br from-[#3E0844] to-[#6B1736] flex items-center justify-center text-white shadow-md">
                  <Sparkles className="w-4.5 h-4.5 sm:w-5 sm:h-5 animate-pulse" />
                </div>
                <div>
                  <span className="text-[8px] sm:text-[9px] font-black uppercase text-[#6B1736] tracking-widest leading-none">Spiritual Exercise</span>
                  <h4 className="font-serif text-sm sm:text-lg font-black text-[#1C0320] mt-0.5">{post.technique.title}</h4>
                </div>
              </div>
              ...
              <div className="space-y-3.5">
                {post.technique.steps.map((step, sIdx) => (
                  <div key={sIdx} className="flex gap-3 sm:gap-4">
                    <span className="w-5.5 h-5.5 sm:w-6 sm:h-6 rounded-full bg-[#3E0844] text-white flex items-center justify-center text-[9px] sm:text-[10px] font-black flex-shrink-0 mt-0.5">
                      {sIdx + 1}
                    </span>
            ...
            <div className="pt-5 sm:pt-6 border-t border-purple-50">
              <h4 className="font-serif text-base sm:text-lg font-black text-[#1C0320] mb-2">Final Attunement Vibe</h4>
            ...
            <div className="pt-6 sm:pt-8 border-t border-purple-50 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
              <div className="text-center sm:text-left">
                <h4 className="font-serif text-sm sm:text-lg font-black text-[#1C0320] flex items-center justify-center sm:justify-start gap-1.5">
                  <Heart className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#6B1736] animate-pulse" /> Connect with this Path
                </h4>
