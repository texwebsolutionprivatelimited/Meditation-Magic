      ...
      <div className="relative pt-2 pb-6 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <span className="inline-flex items-center gap-1.5 text-xs font-bold tracking-widest text-[#6B1736] uppercase mb-4">
            <ShieldCheck className="w-4 h-4 text-[#6B1736] animate-pulse" />
            Legal &amp; Trust
          </span>
      ...
      <div className="max-w-[95%] mx-auto px-3 sm:px-6 lg:px-8 pb-24">
        <div className="bg-white/70 border border-purple-200 rounded-2xl sm:rounded-3xl p-5 sm:p-12 shadow-sm">
          ...
          <Section title="Introduction">
            <p>
              Welcome to <strong className="text-[#1C0320]">Meditation Magic</strong> ("we", "us", or "our"). We are
          ...
          <Section title="Information We Collect">
            ...
            <ul className="list-disc list-inside space-y-1.5">
              <li>Your <strong className="text-[#1C0320]">name, email address, and phone number</strong> when you fill out a contact or inquiry form.</li>
              <li>Your <strong className="text-[#1C0320]">billing and shipping address</strong> when you place an order.</li>
              <li>Any <strong className="text-[#1C0320]">messages or feedback</strong> you send us via WhatsApp, email, or contact forms.</li>
            </ul>
          ...
          <Section title="How We Use Your Information">
            ...
            <p>We do <strong className="text-[#1C0320]">not</strong> sell your personal information to any third party.</p>
          </Section>
          ...
          <Section title="Your Rights">
            ...
            <p>
              ...
              <a href="mailto:meditationmagicofficial@gmail.com" className="text-[#6B1736] hover:underline font-semibold">
